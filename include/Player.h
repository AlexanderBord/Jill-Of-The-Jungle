...
public:
	...
	bool getJumpStatus() { return m_jump; };
	bool getClimbStatus() { return m_climb; };
	bool getShieldStatus() { return m_shield; }; // shield status
	bool getGatePassStatus(){ return m_passedInGate; };
	bool gotEnoughKeys() { return m_gotEnoughKeys; };
	bool getGemGatePassStatus() { return m_passedInGemGate; };
	sf::Vector2f getPosition() { return player_pos; }
	...
	int getDiamondsGoal() { return m_status.get_diamond_goal(); };
	int getKeysGoal() { return m_status.get_key_goal(); };
