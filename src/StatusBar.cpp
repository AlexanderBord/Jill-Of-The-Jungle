...
int StatusBar::get_lives()  const
{
	return m_lives;
}

int StatusBar::get_score() const
{
	return m_score;
}

int StatusBar::get_keys() const
{
	return m_keys;
}

int StatusBar::get_diamond()  const
{
	return m_diamond;
}

int StatusBar::get_key_goal() const
{
	return m_keysGoal;
}

int StatusBar::get_diamond_goal() const
{
