...
// draw function.
void Alligator::draw(sf::RenderWindow& win, float clock_sample) // draws the frog object
{
...
directions_t Alligator::get_direction()
{
	return m_direction;
}

// return the location.
sf::Vector2f Alligator::get_location()
{
	return m_location;
}
